...
export const HEADER_DATA = {
  ...
  text: (
    <>
      <p>
        The idea started with a group of ({chinguLink}) developers who saw a
        need in the community for a tool to help people prepare for technical
        interviews. <br />
      </p>
      <br />
      <p>
        This app aims to help fellow developers get a better sense of weak
        points in their knowledge base, provide resources to improve in those
        areas, and offer some ways to better prepare for technical interviews
      </p>
    </>
  ),
};
    ...
    text: (
      <>
        <p>
          ...
          with our app! We are using GitHub issues to track any bugs or
          incorrect information so they can be resolved by the community.
        </p>
        <br />
        <p>
          Please be sure to check through the issues to make sure the one you
          are seeing hasn’t already been reported. If it has please feel free to
          add comments to the conversation inside the existing issue.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>Report issues / bugs / incorrect information ({issueLink})</p>
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <p>Our app is split into a Front-End (client) and Back-End (server).</p>
        <br />
        <p>
